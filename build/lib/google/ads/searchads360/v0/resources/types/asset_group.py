...
from google.ads.searchads360.v0.enums.types import ad_strength as gase_ad_strength
from google.ads.searchads360.v0.enums.types import asset_group_status
...
class AssetGroup(proto.Message):
    ...
    Attributes:
        ...
        final_mobile_urls (MutableSequence[str]):
            ...
            unless opted out.
        status (google.ads.searchads360.v0.enums.types.AssetGroupStatusEnum.AssetGroupStatus):
        ...
        ad_strength (google.ads.searchads360.v0.enums.types.AdStrengthEnum.AdStrength):
    ...
    ad_strength: gase_ad_strength.AdStrengthEnum.AdStrength = proto.Field(
        proto.ENUM,
        number=10,
        enum=gase_ad_strength.AdStrengthEnum.AdStrength,
    )
