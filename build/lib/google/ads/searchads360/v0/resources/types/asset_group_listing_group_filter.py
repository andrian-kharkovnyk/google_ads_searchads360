...
from google.ads.searchads360.v0.enums.types import listing_group_filter_bidding_category_level
from google.ads.searchads360.v0.enums.types import listing_group_filter_custom_attribute_index
from google.ads.searchads360.v0.enums.types import listing_group_filter_product_channel
from google.ads.searchads360.v0.enums.types import listing_group_filter_product_condition
from google.ads.searchads360.v0.enums.types import listing_group_filter_product_type_level
from google.ads.searchads360.v0.enums.types import listing_group_filter_type_enum
from google.ads.searchads360.v0.enums.types import listing_group_filter_vertical
...
class AssetGroupListingGroupFilter(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            ListingGroupFilter.
        type_ (google.ads.searchads360.v0.enums.types.ListingGroupFilterTypeEnum.ListingGroupFilterType):
            Immutable. Type of a listing group filter
            node.
        vertical (google.ads.searchads360.v0.enums.types.ListingGroupFilterVerticalEnum.ListingGroupFilterVertical):
            Immutable. The vertical the current node tree
            represents. All nodes in the same tree must
            belong to the same vertical.
        case_value (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension):
        ...
        path (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimensionPath):
...
class ListingGroupFilterDimensionPath(proto.Message):
    ...
    Attributes:
        dimensions (MutableSequence[google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension]):
    ...
    dimensions: MutableSequence['ListingGroupFilterDimension'] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message='ListingGroupFilterDimension',
    )
...
class ListingGroupFilterDimension(proto.Message):
    ...
    Attributes:
        product_bidding_category (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductBiddingCategory):
            Bidding category of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_brand (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductBrand):
            Brand of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_channel (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductChannel):
            Locality of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_condition (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductCondition):
            Condition of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_custom_attribute (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductCustomAttribute):
            Custom attribute of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_item_id (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductItemId):
            Item id of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_type (google.ads.searchads360.v0.resources.types.ListingGroupFilterDimension.ProductType):
    ...
    class ProductBiddingCategory(proto.Message):
        ...
        Attributes:
            ...
            level (google.ads.searchads360.v0.enums.types.ListingGroupFilterBiddingCategoryLevelEnum.ListingGroupFilterBiddingCategoryLevel):
    ...
    class ProductChannel(proto.Message):
        ...
        Attributes:
            channel (google.ads.searchads360.v0.enums.types.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel):
    ...
    class ProductCondition(proto.Message):
        ...
        Attributes:
            condition (google.ads.searchads360.v0.enums.types.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition):
    ...
    class ProductCustomAttribute(proto.Message):
        ...
        Attributes:
            value (str):
                ...
                This field is a member of `oneof`_ ``_value``.
            index (google.ads.searchads360.v0.enums.types.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex):
    ...
    class ProductType(proto.Message):
        ...
        Attributes:
            value (str):
                ...
                This field is a member of `oneof`_ ``_value``.
            level (google.ads.searchads360.v0.enums.types.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel):
                Level of the type.
        """
