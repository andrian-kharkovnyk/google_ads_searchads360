...
from google.ads.searchads360.v0.common.types import asset_usage
...
class AssetGroupTopCombinationView(proto.Message):
    ...
    Attributes:
        ...
        asset_group_top_combinations (MutableSequence[google.ads.searchads360.v0.resources.types.AssetGroupAssetCombinationData]):
    ...
    asset_group_top_combinations: MutableSequence['AssetGroupAssetCombinationData'] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class AssetGroupAssetCombinationData(proto.Message):
    ...
    Attributes:
        asset_combination_served_assets (MutableSequence[google.ads.searchads360.v0.common.types.AssetUsage]):
            Output only. Served assets.
    """

    asset_combination_served_assets: MutableSequence[asset_usage.AssetUsage] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
