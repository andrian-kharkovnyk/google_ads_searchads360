...
from google.ads.searchads360.v0.enums.types import asset_set_asset_status
...
class AssetSetAsset(proto.Message):
    ...
    Attributes:
        ...
        asset (str):
            ...
            asset is linking to.
        status (google.ads.searchads360.v0.enums.types.AssetSetAssetStatusEnum.AssetSetAssetStatus):
