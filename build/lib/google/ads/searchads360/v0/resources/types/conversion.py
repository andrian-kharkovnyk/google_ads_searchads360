...
class Conversion(proto.Message):
    ...
    Attributes:
        ...
        merchant_id (int):
            Output only. The SearchAds360 inventory
            account ID containing the product that was
            clicked on. SearchAds360 generates this ID when
            you link an inventory account in SearchAds360.
        ...
        visit_id (int):
            Output only. The SearchAds360 visit ID that
