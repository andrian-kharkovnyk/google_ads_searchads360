...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def list_accessible_customers(self,
            request: Optional[Union[customer_service.ListAccessibleCustomersRequest, dict]] = None,
            *,
        ...
        Args:
            request (Union[google.ads.searchads360.v0.services.types.ListAccessibleCustomersRequest, dict, None]):
        ...
        Returns:
            google.ads.searchads360.v0.services.types.ListAccessibleCustomersResponse:
