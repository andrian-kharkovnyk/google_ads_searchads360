...
from google.ads.searchads360.v0.enums.types import product_bidding_category_level
from google.ads.searchads360.v0.enums.types import product_bidding_category_status
...
class ProductBiddingCategoryConstant(proto.Message):
    ...
    Attributes:
        ...
        level (google.ads.searchads360.v0.enums.types.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel):
            Output only. Level of the product bidding
            category.
        status (google.ads.searchads360.v0.enums.types.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus):
